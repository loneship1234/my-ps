...
function Accordion() {
  return (
    <div class="flow-root">
    <div class="-my-8 divide-y divide-gray-100 text-white">
      <details class="py-8 bg-gray-900 mx-16  group" open>
        <summary class="flex bg-gray-600 items-center justify-between cursor-pointer">
          <h5 class="text-lg font-medium text-gray-white">
        ...
        <p class="mt-4 leading-relaxed text-gray-700 bg-gray-600">
