...
function Main() {
  ...
  return (
    <div className=" w-full lg:h-[33.2em] h-[22em] bg-blue- lg:mt-2 overflow-hidden flex h- pr-0 pl-0 mt-0 lg:pl-[55px] lg:pr-16">
      <div className=" w-screen flex-shrink flex items-start  lg:px-0 px-4  ">
